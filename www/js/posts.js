...
function rellenarPosts(data, htmlString) {
	...
	$.each(data.posts, function(i, p) {
		...
		htmlString += '  </div>'
		if (getCookie("username") != p.username)
			htmlString += '  <div class="post-opciones"><a class="post-popover" rel="popover" data-toggle="popover" data-content="<a href=\'javascript:void(0);\' onClick=\'processDenuncia(' + p.identificador
					+ ');\'>Denunciar</a>" data-html="true"><img src="img/options.png"/></a></div>'
		else
			htmlString += '  <div class="post-opciones"><a class="post-popover" rel="popover" data-toggle="popover" data-content="<a href=\'javascript:void(0);\' onClick=\'processPostVisibilidad(0,' + p.identificador
					+ ');\'>An&oacute;nimo</a><br><a href=\'javascript:void(0);\' onClick=\'processPostVisibilidad(1,' + p.identificador + ');\'>S&oacute;lo amigos</a><br><a href=\'javascript:void(0);\' onClick=\'processPostVisibilidad(2,'
					+ p.identificador + ');\'>P&uacute;blico</a>" data-html="true"><img src="img/options.png"/></a></div>'
		...
		htmlString += '<a href="javascript:void(0);" class="btna" rel="popover" data-toggle="popover" data-content="<a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(0,' + p.identificador
				+ ');\'>An&oacute;nimo</a><br><a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(1,' + p.identificador + ');\'>S&oacute;lo amigos</a><br><a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(2,' + p.identificador
				+ ');\'>P&uacute;blico</a>" data-html="true">'
...
function rellenarComentarios(data, htmlString, identificador) {
	...
	$.each(data.comentarios, function(i, c) {
		...
		if (user != c.username)
			...
			htmlString += '<a href="javascript:void(0);" class="comentario-popover" rel="popover" data-toggle="popover" data-content="<a href=\'javascript:void(0);\' onClick=\'processComentarioVisibilidad(0,' + c.id_post + ',' + c.identificador
					+ ');\'>An&oacute;nimo</a><br><a href=\'javascript:void(0);\' onClick=\'processComentarioVisibilidad(1,' + c.id_post + ',' + c.identificador
					+ ');\'>S&oacute;lo amigos</a><br><a href=\'javascript:void(0);\' onClick=\'processComentarioVisibilidad(2,' + c.id_post + ',' + c.identificador + ');\'>P&uacute;blico</a>" data-html="true">'
	...
	$.ajax({
		...
		beforeSend : function(request) {
			...
			function(data, status, jqxhr) {
				...
				var mifoto = getCookie("imagen");
				$.each(data.posts, function(i, p) {
					htmlString += '<div class="post-validacion" id="valPost' + p.identificador + '">'
					htmlString += '<div class="post-validar-izq" onClick="processModerar(' + p.identificador + ')"><a href="javascript:void(0);"><img src="img/valid.png"/>&nbsp;&nbsp;Validar</a></div>'
					htmlString += '<div class="post-validar-der" onClick="processEliminar(' + p.identificador + ')"><a href="javascript:void(0);"><img src="img/error.png"/>&nbsp;&nbsp;Eliminar</a></div>'
					htmlString += '</div>'
					htmlString += '<div class="post" id="post' + p.identificador + '">'
					htmlString += '  <div class="post-imagen"><img src="' + p.imagen_usuario + '" width=50px height=50px></img></div>'
					htmlString += '  <div class="post-usuario">'
					...
					htmlString += '    <div class="post-comentario-mifoto" style="background-image:url(\'' + mifoto + '\');background-size:50px 50px;">'
					htmlString += '<a href="javascript:void(0);" class="btna" rel="popover" data-toggle="popover" data-content="<a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(0,' + p.identificador
							+ ');\'>An&oacute;nimo</a><br><a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(1,' + p.identificador + ');\'>S&oacute;lo amigos</a><br><a href=\'javascript:void(0);\' onClick=\'cambiarVisibilidad(2,'
							+ p.identificador + ');\'>P&uacute;blico</a>" data-html="true">'
					htmlString += '<img src="" width=50px height=50px id="foto-comentario' + p.identificador + '"></img>'
					htmlString += '</a>'
					htmlString += '</div>'
					htmlString += '    <div id="mi-comentario-visibilidad' + p.identificador + '" style="display:none;">0</div>'
