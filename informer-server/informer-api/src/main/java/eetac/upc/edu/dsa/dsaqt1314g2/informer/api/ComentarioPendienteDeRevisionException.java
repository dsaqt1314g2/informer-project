...
public class ComentarioPendienteDeRevisionException extends WebApplicationException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4110163799971920585L;
	private final static String MESSAGE = "Comentario pendiente de revisión";
	public ComentarioPendienteDeRevisionException() {
		super(Response
