...
public class MensajeCollectionNotFoundException extends WebApplicationException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4110163799971920585L;
	private final static String MESSAGE = "Coleccion de mensajes no encontrada";
	public MensajeCollectionNotFoundException() {
		super(Response
