...
public class PostNotRevisableException extends WebApplicationException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4110163799971920585L;
	private final static String MESSAGE = "Este post no esta pendiente de revision";
	public PostNotRevisableException() {
		super(Response
