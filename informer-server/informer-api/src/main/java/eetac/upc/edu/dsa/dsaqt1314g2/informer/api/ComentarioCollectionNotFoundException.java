...
public class ComentarioCollectionNotFoundException extends WebApplicationException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4110163799971920585L;
	private final static String MESSAGE = "Coleccion de comentarios no encontrada";
	public ComentarioCollectionNotFoundException() {
		super(Response
