...
public class ComentarioDenunciadoException extends WebApplicationException {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4110163799971920585L;
	private final static String MESSAGE = "Comentario denunciado";
	public ComentarioDenunciadoException() {
		super(Response
