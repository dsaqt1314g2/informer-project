...
import eetac.upc.edu.dsa.rodrigo.libros.api.InternalServerException;
import eetac.upc.edu.dsa.rodrigo.libros.api.LibroNotFoundException;
import eetac.upc.edu.dsa.rodrigo.libros.api.ServiceUnavailableException;
...
public class UserResource {
	...
	public User createUser(User user) {
		...
		try {
			...
			String sql = "insert into perfiles (username, name, correo, genero, fecha_nacimiento, uni_escuela, foto, estado_civil, lugar_de_residencia, participar_GPS)";
			sql += "values ('" + user.getUsername() + "', '" + user.getName()
					...
					+ ",'" + user.getLugar_de_residencia() + "',"+ user.getParticipar_GPS() + "');";
			...
			if (rs.next()) {
				...
				sql = "select last_Update from perfiles where identificador=" + id;
	...
	public User updateUser(@PathParam("username") String username, User user) {
		...
		try {
			...
			String sql = "update  perfiles SET perfiles.name='"
					...
					+ "', perfiles.fecha_nacimineto='" + fechanacimineto
