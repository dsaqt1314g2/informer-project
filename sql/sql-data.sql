...
insert into perfiles(username, name, genero,fecha_nacimiento, correo, uni_escuela,foto) values ('ropnom','Rodrigo', true,'1991-02-05','rodri@go.com',1,'http://files3.soniccdn.com/imagehosting/99/ubuntuone_37880_640.jpg');
insert into perfiles(username, name, genero,fecha_nacimiento, correo, uni_escuela, foto) values ('McD0n3ld','Raul',true,'1991-11-17','raul@go.com',1,'http://www.otromundoesposible.net/wp-content/uploads/2013/03/mariposa-morfo-azul.jpg');
...
INSERT INTO `informerdb`.`comentarios` (`identificador`, `id_post`, `username`, `visibilidad`, `contenido`, `publicacion_date`, `revisado`, `who_revisado`) VALUES ('9', '3', 'alicia', '1', 'jajajaj si', CURRENT_TIMESTAMP, '1', 'ropnom');
